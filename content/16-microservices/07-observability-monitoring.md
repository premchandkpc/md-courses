...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Microservices Health Metrics</div>
  <div class="obs-grid">
    <div class="obs-card">
      <div class="obs-label">Requests/sec</div>
      <div class="obs-value metric-healthy">5,678</div>
    ...
    <div class="obs-card">
      ...
      <div class="obs-value metric-healthy">0.05</div>
...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Distributed Request Tracing</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">API Gateway</div>
    <div class="flow-arrow">↓ trace_id</div>
    <div class="flow-node">User Service</div>
    <div class="flow-arrow">↓ span_id</div>
    <div class="flow-node">Order Service</div>
    <div class="flow-arrow">↓ parent_span_id</div>
