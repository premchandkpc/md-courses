...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Filesystem I/O Path</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">read() syscall</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">VFS layer</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Filesystem driver</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Block device</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Storage device</div>
  </div>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">I/O Statistics</div>
  <div class="obs-grid">
    <div class="obs-card"><div class="obs-label">Throughput</div><div class="obs-value metric-healthy">450</div><div class="obs-unit">MB/s</div></div>
    <div class="obs-card"><div class="obs-label">IOPS</div><div class="obs-value metric-healthy">12500</div><div class="obs-unit">ops/s</div></div>
    <div class="obs-card"><div class="obs-label">Latency P99</div><div class="obs-value metric-healthy">8.5</div><div class="obs-unit">ms</div></div>
    <div class="obs-card"><div class="obs-label">Queue Depth</div><div class="obs-value metric-warning">24</div><div class="obs-unit">reqs</div></div>
  </div>
</div>
