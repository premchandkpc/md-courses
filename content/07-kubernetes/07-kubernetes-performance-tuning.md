...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="slider-title">Cluster Tuning Parameters</div>
  <div class="slider-container">
    <label class="slider-label">API Server Concurrency:</label>
    <div class="slider-wrapper">
      <input type="range" min="100" max="2000" value="400" class="slider-input" id="api-slider">
      <span class="slider-value" id="api-value">400</span>
    </div>
    <label class="slider-label">etcd Compaction (min):</label>
    <div class="slider-wrapper">
      <input type="range" min="1" max="60" value="5" class="slider-input" id="etcd-slider">
      <span class="slider-value" id="etcd-value">5 min</span>
    </div>
  </div>
  <script>
    const apiSlider = document.getElementById('api-slider');
    const etcdSlider = document.getElementById('etcd-slider');
    const apiValue = document.getElementById('api-value');
    const etcdValue = document.getElementById('etcd-value');
    apiSlider.addEventListener('input', (e) => {
      apiValue.textContent = e.target.value;
    });
    etcdSlider.addEventListener('input', (e) => {
      etcdValue.textContent = e.target.value + ' min';
    });
  </script>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">System Performance</div>
  <div class="obs-grid">
    <div class="obs-card">
      <div class="obs-label">API Latency p99</div>
      <div class="obs-value metric-healthy">45</div>
      <div class="obs-unit">ms</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">etcd Fsync</div>
      <div class="obs-value metric-healthy">8</div>
      <div class="obs-unit">ms</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">DNS Latency</div>
      <div class="obs-value metric-warning">120</div>
      <div class="obs-unit">ms</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Pod Startup</div>
