...
## Interactive Component 1: Performance Optimization Tuning
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="slider-title">Code Splitting Configuration</div>
  <div class="slider-container">
    <label class="slider-label">Chunk Size Threshold (KB):</label>
    <div class="slider-wrapper">
      <input type="range" min="50" max="1000" value="200" class="slider-input" id="chunk-slider">
      <span class="slider-value" id="chunk-value">200 KB</span>
    </div>
  </div>
  <script>
    const slider = document.getElementById('chunk-slider');
    const value = document.getElementById('chunk-value');
    slider.addEventListener('input', (e) => { value.textContent = e.target.value + ' KB'; });
  </script>
</div>
```

## Interactive Component 2: Performance Metrics Dashboard
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Bundle & Performance Metrics</div>
  <div class="obs-grid">
    <div class="obs-card"><div class="obs-label">Bundle Size</div><div class="obs-value metric-healthy">242</div><div class="obs-unit">KB</div></div>
    <div class="obs-card"><div class="obs-label">Gzip</div><div class="obs-value metric-healthy">68</div><div class="obs-unit">KB</div></div>
    <div class="obs-card"><div class="obs-label">Parse Time</div><div class="obs-value metric-healthy">145</div><div class="obs-unit">ms</div></div>
    <div class="obs-card"><div class="obs-label">Main Chunks</div><div class="obs-value metric-healthy">12</div><div class="obs-unit">files</div></div>
  </div>
</div>
```
