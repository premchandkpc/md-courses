...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Kernel Tracing Flow</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">ftrace/perf</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Kernel events</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Ring buffer</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">User space</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Analysis/flame graph</div>
  </div>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Tracing Overhead</div>
  <div class="obs-grid">
    <div class="obs-card"><div class="obs-label">Buffer Size</div><div class="obs-value metric-healthy">4096</div><div class="obs-unit">KB</div></div>
    <div class="obs-card"><div class="obs-label">Events/sec</div><div class="obs-value metric-healthy">156000</div><div class="obs-unit">evt/s</div></div>
    <div class="obs-card"><div class="obs-label">CPU Overhead</div><div class="obs-value metric-healthy">2.3</div><div class="obs-unit">%</div></div>
    <div class="obs-card"><div class="obs-label">Lost Events</div><div class="obs-value metric-warning">12</div><div class="obs-unit">pkt</div></div>
  </div>
</div>
