...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Async I/O Path (epoll)</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">epoll_wait()</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Kernel event queue</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Device ready</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Return fd + events</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Application read/write</div>
  </div>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Blocking I/O Metrics</div>
  <div class="obs-grid">
    <div class="obs-card"><div class="obs-label">Throughput</div><div class="obs-value metric-healthy">250</div><div class="obs-unit">MB/s</div></div>
    <div class="obs-card"><div class="obs-label">Concurrency</div><div class="obs-value metric-healthy">100</div><div class="obs-unit">threads</div></div>
    <div class="obs-card"><div class="obs-label">Latency P99</div><div class="obs-value metric-warning">45</div><div class="obs-unit">ms</div></div>
    <div class="obs-card"><div class="obs-label">Memory</div><div class="obs-value metric-warning">800</div><div class="obs-unit">MB</div></div>
  </div>
</div>
