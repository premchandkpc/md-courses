...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Observability Data Flow</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">Metrics (Prometheus)</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Logs (Loki/ELK)</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Traces (Tempo/Jaeger)</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Visualization (Grafana)</div>
    <div class="flow-arrow">↓</div>
    <div class="flow-node">Alerting (AlertManager)</div>
  </div>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Observability Pipeline Health</div>
  <div class="obs-grid">
    <div class="obs-card">
      <div class="obs-label">Metrics Ingested</div>
      <div class="obs-value metric-healthy">2.3M</div>
      <div class="obs-unit">series/sec</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Log Volume</div>
      <div class="obs-value metric-healthy">125</div>
      <div class="obs-unit">GB/h</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Trace Sampling</div>
      <div class="obs-value metric-healthy">1%</div>
      <div class="obs-unit">success</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Alert Latency</div>
