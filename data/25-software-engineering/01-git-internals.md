...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">Git Commit Workflow</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">Working Directory</div>
    <div class="flow-arrow">↓ git add</div>
    <div class="flow-node">Staging Area</div>
    <div class="flow-arrow">↓ git commit</div>
    <div class="flow-node">Commit Object</div>
    <div class="flow-arrow">↓ tree + blob</div>
    <div class="flow-node">Object Database</div>
  </div>
</div>
