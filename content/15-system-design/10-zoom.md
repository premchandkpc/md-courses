...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="topology-title">Zoom Video Conferencing Architecture</div>
  <svg class="topology-svg" viewBox="0 0 600 300">
    ...
    <g><rect x="80" y="120" width="80" height="50" rx="4" fill="#1e3a5f" stroke="#00d4ff" stroke-width="1"/><text x="120" y="150" text-anchor="middle" fill="#e3eaf0" font-size="12" font-family="monospace">Media Server</text></g>
    <g><rect x="260" y="120" width="80" height="50" rx="4" fill="#1e3a5f" stroke="#00d4ff" stroke-width="1"/><text x="300" y="150" text-anchor="middle" fill="#e3eaf0" font-size="12" font-family="monospace">Signaling</text></g>
    <g><rect x="440" y="120" width="80" height="50" rx="4" fill="#1e3a5f" stroke="#00d4ff" stroke-width="1"/><text x="480" y="150" text-anchor="middle" fill="#e3eaf0" font-size="12" font-family="monospace">Registry</text></g>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="obs-title">Zoom Production Metrics</div>
  <div class="obs-grid">
    <div class="obs-card">
      <div class="obs-label">Concurrent Participants</div>
      <div class="obs-value metric-healthy">300M</div>
      <div class="obs-unit">daily</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Video Bitrate</div>
      <div class="obs-value metric-healthy">2.5</div>
      <div class="obs-unit">Mbps</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Jitter Buffer</div>
      <div class="obs-value metric-healthy">200</div>
      <div class="obs-unit">ms</div>
    </div>
    <div class="obs-card">
      <div class="obs-label">Packet Loss</div>
