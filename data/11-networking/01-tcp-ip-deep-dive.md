...
<div style="display:flex;flex-direction:column;align-items:center;gap:8px;padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="flow-title">TCP 3-Way Handshake</div>
  <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
    <div class="flow-node">Client (CLOSED)</div>
    <div class="flow-arrow">↓ SYN (seq=x)</div>
    <div class="flow-node">Server (LISTEN)</div>
    <div class="flow-arrow">↓ SYN-ACK (seq=y, ack=x+1)</div>
    <div class="flow-node">Client (SYN_SENT)</div>
    <div class="flow-arrow">↓ ACK (seq=x+1, ack=y+1)</div>
    <div class="flow-node">Server (ESTABLISHED)</div>
  </div>
</div>
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="state-machine-title">TCP Connection States</div>
  <div class="state-demo">
    ...
    <div class="state-buttons">
      ...
      <button class="state-button" onclick="setTcpState('SYN_SENT')">SYN Sent</button>
      ...
      <button class="state-button" onclick="setTcpState('CLOSED')">Closed</button>
    </div>
  </div>
  <script>
    const tcpMap = {
      'LISTEN': { label: 'LISTEN', class: 'state-listen' },
      'SYN_SENT': { label: 'SYN_SENT', class: 'state-listen' },
...
<div style="padding:16px;background:#0b0e14;border:1px solid #1e2a3a;border-radius:8px">
  ...
  <div class="slider-title">TCP Window Size Configuration</div>
  <div class="slider-container">
    <label class="slider-label">Receiver Window (rwnd):</label>
    <div class="slider-wrapper">
      <input type="range" min="64" max="65536" value="16384" class="slider-input" id="window-slider">
      <span class="slider-value" id="window-value">16384 bytes</span>
    </div>
  </div>
  <script>
    const slider = document.getElementById('window-slider');
    const value = document.getElementById('window-value');
    slider.addEventListener('input', (e) => { value.textContent = e.target.value + ' bytes'; });
  </script>
</div>
