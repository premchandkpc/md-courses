...
**Related**: [Collections Framework](02-collections-framework.md) · [Generics](08-generics.md) · [Exception Handling](03-exception-handling.md)
...
**Next**: [Generics](08-generics.md) — Type safety, wildcards, type erasure
